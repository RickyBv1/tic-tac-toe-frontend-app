...
@Component({
  selector: 'app-fullscreen-mode',
  imports: [],
  templateUrl: './fullscreen-mode.component.html',
  styleUrl: './fullscreen-mode.component.scss',
  animations: [
    trigger ('animateChildren', [
      transition ('* => void', [
        query('@*', [animateChild()], {optional: true})
        //this 'dummy' animation comes from an angular bug
        //credits to: https://github.com/angular/angular/issues/23302
      ])]),
    trigger('fadeInOut', [
      transition(':enter',[
        style({opacity: 0}),
...
export class FullscreenModeComponent {
